...
void Task_State(void)
{
	...
	if(voltage>=12000)						{rt_Power=100;}//电量剩余100%
	if((voltage<12000)&&(voltage>=11800))	{rt_Power=75;}	//电量剩余75%
	if((voltage<11800)&&(voltage>=11400))   {rt_Power=50;}	//电量剩余50%
	if((voltage<11400)&&(voltage>=11200))	{rt_Power=25;}	//电量剩余25%
	if(voltage<11200)
	{
		rt_Power=0;
		if(voltage>9000)//低压报警
		{				//电池在调试的时候可能会关闭，
			BUZZ=1;//蜂鸣器哔哔响
		}
	}	
