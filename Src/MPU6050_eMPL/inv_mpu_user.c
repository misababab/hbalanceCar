...
struct mpu6050_data mpu6050Struct;
...
u8 mpu_dmp_get_data(void)
{
	...
	**/
	...
	mpu6050Struct.acc_x = accel_dmp[0];
	mpu6050Struct.acc_y = accel_dmp[1];
	mpu6050Struct.acc_z = accel_dmp[2];
	
	mpu6050Struct.gyro_x = gyro_dmp[0];
	mpu6050Struct.gyro_y = gyro_dmp[1];
	mpu6050Struct.gyro_z = gyro_dmp[2];
	
	mpu6050Struct.pitch = pitch;
	mpu6050Struct.roll  = roll;
	mpu6050Struct.yaw   = yaw;
